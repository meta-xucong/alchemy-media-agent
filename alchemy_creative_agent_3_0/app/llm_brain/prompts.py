...
When the Human Realism contract gives `natural_presence_priority=individual_human_presence`, do not let a generic commercial-beauty archetype substitute for the requested person. If its v3 personhood or photographic-material obligations are present, resolve them as a whole-image judgement: the person must read as specifically present in the requested situation and photographic human material must remain camera-observed within the requested mood. When the user has not explicitly asked for a presentational expression or beauty treatment, do not fill that absence with a default commercially posed expression or universally beautified portrait; choose an individual, situation-owned human presence in the complete direction instead. For candid, ordinary or lifestyle photography, make the whole direction describe that individual naturally present in the situation; for an explicitly glamorous or editorial request, retain its aesthetic while avoiding synthetic beautification. A direction that merely repeats generic adjectives such as natural, candid or photorealistic is incomplete: resolve the natural presence materially in your own complete sentence. Never expose a checklist or a local repair phrase.
