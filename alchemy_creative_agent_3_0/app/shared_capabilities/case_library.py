...
DEFAULT_CASES = [
    {
        ...
        "style_tags": ["clean", "bright", "commercial"],
        "composition_tags": ["large hero", "headline safe area", "simple background"],
        "use_case_tags": ["poster", "social", "launch"],
        "visual_signals": ["large central hero", "clear text zones", "bright clean lighting"],
    },
    {
        ...
        "composition_tags": ["square crop", "safe margins", "bold headline"],
        "use_case_tags": ["social", "cover", "campaign"],
        "visual_signals": ["square composition", "headline-safe top region", "clean subject separation"],
    },
    {
