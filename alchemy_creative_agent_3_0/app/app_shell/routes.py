...
ROUTE_CONTRACTS = {
    ...
    "get_mcp_materialization": f"{API_NAMESPACE}/mcp-materializations/{{handoff_id}}",
    "submit_mcp_materialization": f"{API_NAMESPACE}/mcp-materializations/{{handoff_id}}/submit",
