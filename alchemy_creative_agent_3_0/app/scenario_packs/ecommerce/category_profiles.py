"""Category evidence questions for a remote-Brain E-Commerce request.

Category knowledge can help the Brain discover facts worth clarifying, but it
must never silently choose a fixed image sequence, camera treatment, or scene.
"""
...
CATEGORY_PROFILE_VERSION = "v3_ecommerce_evidence_questions_2026_07_13"
