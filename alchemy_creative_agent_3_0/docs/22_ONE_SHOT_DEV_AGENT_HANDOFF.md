...
The run must not expand into full dedicated ecommerce, new-media,
private-community, brand-IP, AI manga-drama, or other vertical-pack
implementation unless the user explicitly requests that extra scope. Those
cards are current-stage placeholders only.
...
For any work after this one-shot handoff, especially V3 foundation gap closure,
V1/V2 capability migration, General Creative shared-capability integration, or
E-Commerce specialization, continue with:
...
Those supplemental docs do not expand the current one-shot scope by default.
They define the correct follow-up order once the user explicitly asks to continue
beyond the current General Creative / Scenario Hub stage.
...
5. Compare current implementation against docs 17-22.
