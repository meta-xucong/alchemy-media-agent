...
DEFAULT_LLM_MODEL=${DEFAULT_LLM_MODEL:-gpt-5.5}
BACKUP_LLM_PROVIDER=${BACKUP_LLM_PROVIDER:-deepseek}
BACKUP_LLM_MODEL=${BACKUP_LLM_MODEL:-deepseek-v4-pro-260425}
...
LAB_DOUBAO_VISION_MODEL=${LAB_DOUBAO_VISION_MODEL:-doubao-seed-2-0-lite-260428}
