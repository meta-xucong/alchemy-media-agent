...
class Settings:
    ...
    openai_image_high_resolution_timeout_seconds: float = 900.0
    ...
    claude_checkpoint_soft_stage_timeout_seconds: float = 90.0
...
def load_settings() -> Settings:
    return Settings(
        ...
        openai_image_high_resolution_timeout_seconds=float(
            os.getenv("V2_OPENAI_IMAGE_HIGH_RESOLUTION_TIMEOUT_SECONDS", "900")
        ),
        ...
        claude_checkpoint_soft_stage_timeout_seconds=max(
            15.0,
            float(os.getenv("V2_CLAUDE_CHECKPOINT_SOFT_STAGE_TIMEOUT_SECONDS", "90")),
        ),
