...
def test_v3_commercial_shell_is_in_desktop_product_navigation() -> None:
    ...
    assert "/static/styles.css?v=20260809-v3-create-asset-prebind" in index.text
    assert "/static/app.js?v=20260809-v3-create-asset-prebind" in index.text
...
def test_v3_frontend_assets_use_v3_namespace_and_card_module_styles() -> None:
    ...
    assert "/mobile-static/mobile.js?v=20260809-v3-create-asset-prebind" in mobile_index.text
