...
- Functional reference: existing desktop V1/V2/Alchemy Lab application.
...
- Interaction: passed. V1/V2/Lab/V3 switching works; V2 templates load; V1 and V2 functional nodes are present; model controls, upload controls, revision/history controls, and provider controls are mounted. The Alchemy shell does not expose a video tab.
