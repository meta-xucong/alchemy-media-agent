"""Doc130 native ImageGen stdio MCP: canonical prompt projection, no image transport."""
...
TOOL_SCHEMAS: list[dict[str, Any]] = [
    {
        ...
        "description": "Prepare exact canonical V3 GPT Image 2 prompts for one explicit Codex Native ImageGen request; the MCP never creates, imports, or stores an image.",
        "inputSchema": {
            "type": "object",
...
def dispatch(adapter: CodexNativeImageGenFacade, request: dict[str, Any]) -> dict[str, Any] | None:
    ...
    if method == "initialize":
        result: dict[str, Any] = {
            ...
            "capabilities": {"tools": {}},
            "serverInfo": {"name": "alchemy-codex-native-imagegen", "version": "0.5.0-doc130-canonical-prompt"},
        }
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Doc130 canonical-prompt stdio MCP bridge")
